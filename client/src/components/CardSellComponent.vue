      ...
      <CardContent>
        <div class="flex items-center mt-2.5">
          ...
          <div class="ml-1 flex items-center space-x-1 rtl:space-x-reverse">
            <!-- Full stars -->
            <svg
              v-for="n in starRating.fullStars"
              :key="'full-' + n"
