  ...
  `).join('');
    ...
    let info = await transporter.sendMail({
      ...
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #000; border: 1px solid #e0e0e0; padding: 20px; border-radius: 5px;">
        ...
        <p style="color: #000;">Votre date de livraison estimée est indiquée ci-dessous. Vous pouvez suivre l'état de votre commande dans <a href="https://sellerto.store/orders" style="color: #000;">Vos commandes sur SellerTo</a>.</p>
        ...
        <a href="https://example.com/order-details" style="display: inline-block; padding: 10px 20px; margin: 20px 0; background-color: #0e51c2; color: #fff; text-decoration: none; border-radius: 5px;">Afficher les détails de la commande</a>
