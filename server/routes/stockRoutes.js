...
import {createStock, deleteStock, findStockById, getAllStock, patchStock, updateStock,} from "../controllers/stockController.js";
...
router.get("/:id", findStockById, checkAuth, checkRole(["Admin", "SuperAdmin"]));
router.patch("/:id", patchStock, checkAuth, checkRole(["Admin", "SuperAdmin"]));
router.delete("/:id", deleteStock, checkAuth, checkRole(["Admin", "SuperAdmin"]));
